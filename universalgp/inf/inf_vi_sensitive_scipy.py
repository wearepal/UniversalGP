...
class VariationalSensitiveScipy:
    """
    ...
    def inference(self, features, train_outputs, is_train):
        ...
        ell = self._build_ell(weights, self.means, chol_covars, self.inducing_inputs, kernel_chol, train_inputs, train_outputs)
        ...
        return {'NELBO': tf.squeeze(nelbo)}, vars_to_train, [constraint]
